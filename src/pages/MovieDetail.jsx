...
const MovieDetail = () => {
  ...
  useEffect(() => {
    axios.get(`https://api.themoviedb.org/3/movie/${id}?api_key=${API_KEY}`).then((res) => setDetay(res.data));
  }, []);
        ...
        <div className="flex flex-col lg:flex-row max-w-6xl rounded-lg bg-gray-100 shadow-lg">
          ...
          <div className="p-6 flex flex-col justify-between">
            ...
            <ul className="bg-gray-100 rounded-lg border border-gray-400 text-gray-900">
              ...
              <li className="px-6 py-2 border-b border-gray-400 w-full">{"Rate : " + detay.vote_average}</li>
              <li className="px-6 py-2 border-b border-gray-400 w-full">{"Total Vote : " + detay.vote_count}</li>
